...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/normalize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/grid.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/base.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/blocks.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/layouts.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/modules.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/widgets-styles.css') }}">


    <!--Plugins styles-->

    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/front/html/css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/swiper.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/primary-menu.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/magnific-popup.css') }}">

    <!--Styles for RTL-->

    <!--<link rel="stylesheet" type="text/css" href="{{ asset('assets/front/html/css/rtl.css') }}">-->
...
<body class=" ">
        ...
        <div class="container">
            ...
            <div class="header-content-wrapper">
                ...
                <div class="logo">
                    ...
                    <img src="{{ asset('assets/front/html/img/logo-eye.png') }}" style="" alt="Seosight">
                    <div class="logo-text">
                ...
                <nav id="primary-menu" class="primary-menu">
                    ...
                    <ul class="primary-menu-menu">
                        ...
                        <li class="has-megamenu menu-item-has-children">
                            ...
                            <div class="megamenu"
                                style="background-image: url('assets/front/html/img/menu-bg.png');">
                                <div class="megamenu-row">
                                    ...
                                    <div class="col3">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="02_abouts.html">Our Agency<i
                                            ...
                                            <li>
                                                <a href="10_testimonials.html">Testimonials <i
                                                        class="seoicon-right-arrow"></i></a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col3">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="typography.html">Typography<i
                                                        class="seoicon-right-arrow"></i></a>
                                            </li>
                                            <li>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="google-logo">
                                                    <img src="{{ asset('assets/front/html/img/google-logo.png') }}"
                                                        alt="logo">
                                                </div>
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
        ...
        <div class="popup right-menu">
            ...
            <div class="right-menu-wrap">
                ...
                <div class="logo">
                    <a href="{{ url('/') }}" class="full-block-link"></a>
                    <img src="{{ asset('assets/front/html/img/logo-eye.png') }}" alt="Seosight">
                    <div class="logo-text">
                        <div class="logo-title">Seosight</div>
                    </div>
                </div>
            ...
            <div class="widget contacts">
                ...
                <div class="contacts-item">
                    <img src="{{ asset('assets/front/html/img/contact4.png') }}" alt="phone">
                    <div class="content">
                ...
                <div class="contacts-item">
                    <img src="{{ asset('assets/front/html/img/contact5.png') }}" alt="phone">
                    <div class="content">
                ...
                <div class="contacts-item">
                    <img src="{{ asset('assets/front/html/img/contact6.png') }}" alt="phone">
                    <div class="content">
                ...
                <div class="info">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        <div class="heading">
                            ...
                            <p class="heading-text">Qolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                nibham
                                liber tempor cum soluta nobis eleifend option congue nihil uarta decima et quinta.
                                Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis
                                nisl
                                ut aliquip ex ea commodo consequat eleifend option nihil. Investigationes
                                demonstraverunt
                        ...
                        <div class="socials">
                            ...
                            <a href="" class="social__item">
                                <img src="{{ asset('assets/front/html/svg/rss.svg') }}" alt="rss">
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <span>
                            Copyright © 2016 <a href="{{ url('/') }}" class="sub-footer__link">Seosight,</a>
  ...
  c-4.6,0-8.4,3.9-8.4,8.5c0,4.6,3.8,8.5,8.4,8.5h14.2c1.5,0,2.7-1,2.7-2.5C149.3,434.9,148.1,433.9,146.7,433.9z"></path>
    ...
    <script src="{{ asset('assets/front/html/js/jquery-2.1.4.min.js') }}"></script>
    <script src="{{ asset('assets/front/html/js/crum-mega-menu.js') }}"></script>
    <script src="{{ asset('assets/front/html/js/swiper.jquery.min.js') }}"></script>
    <script src="{{ asset('assets/front/html/js/theme-plugins.js') }}"></script>
    <script src="{{ asset('assets/front/html/js/main.js') }}"></script>
    <script src="{{ asset('assets/front/html/js/form-actions.js') }}"></script>
